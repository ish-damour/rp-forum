...
//            ResultSet resultSet = psSelect.executeQuery();
         ...
         String query = "SELECT * FROM blogs,users where users.user_id=blogs.user_id";
...
%>
    <div class="card mb-3">
        ...
        <div class="card-body"> 
            <h3><%=title%></h3>
            <p id="truncatedContent"><%= truncatedText %><a href="#" onclick="expandText();">... (read more)</a></p>
            <p id="expandedContent" style="display: none;"><%= fullText %><a href="#" onclick="collapseText();"> (show less)</a></p>
